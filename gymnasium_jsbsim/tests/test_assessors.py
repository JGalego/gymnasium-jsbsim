...
from gymnasium_jsbsim.assessors import AssessorImpl, ContinuousSequentialAssessor
from gymnasium_jsbsim.tests import stubs as stubs
    ...
    def test_calculate_single_base_component(self):
        for positive_rewards in (True, False):
            ...
            expected_non_shaping_reward = (
                expected_shaping_reward  # should be same because not shaping
            )
