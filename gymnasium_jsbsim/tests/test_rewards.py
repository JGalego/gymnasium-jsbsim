...
import gymnasium_jsbsim.tests.stubs as stubs
from gymnasium_jsbsim import constants
from gymnasium_jsbsim.rewards import (
...
class TestAsymptoticErrorComponent(AbstractTestErrorComponent):
    ...
    def test_calculate_same_perfect_states_shaping_terminal(self):
        ...
        potential_diff = (
            constants.POTENTIAL_BASED_DIFFERENCE_TERMINAL_VALUE - self.PERFECT_POTENTIAL
        )
        self.assertAlmostEqual(
            potential_diff, component.calculate(state, last_state, terminal)
        )
...
class TestLinearShapingComponent(AbstractTestErrorComponent):
    ...
    def test_calculate_get_potential_perfect_state_terminal(self):
        ...
        self.assertAlmostEqual(
            constants.POTENTIAL_BASED_DIFFERENCE_TERMINAL_VALUE,
