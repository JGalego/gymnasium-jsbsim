...
from gymnasium_jsbsim.tasks import Task, HeadingControlTask, TurnHeadingControlTask, Shaping
from gymnasium_jsbsim.aircraft import Aircraft, cessna172P, a320, f15
        ...
        for _plane in (cessna172P, a320, f15):
            for _shaping in (Shaping.STANDARD, Shaping.EXTRA, Shaping.EXTRA_SEQUENTIAL):
                for _enable_flightgear in (True, False):
                    _env_id = utils.get_env_id(task_type, _plane, _shaping, _enable_flightgear)
